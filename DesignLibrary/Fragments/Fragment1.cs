...
namespace DesignLibrary.Fragments
{
    public class Fragment1 : SupportFragment
    {
        ...
        {
            var recyclerView = inflater.Inflate(Resource.Layout.Fragment1, container, false) as RecyclerView;
        ...
        public class SimpleStringRecyclerViewAdapter : RecyclerView.Adapter
        {
            ...
            public SimpleStringRecyclerViewAdapter(Android.Content.Context context, List<string> values, Resources resources)
            {
